...
public:
    ...
    /**
     * @brief Compute the velocity to perform flocking.
     ...
     */
    geometry_msgs::Vector3 flocking_velocity (geometry_msgs::Vector3 velocity);

    /**
     * @brief Compute the velocity to form a specific shape.
     ...
     */
    geometry_msgs::Vector3 formation_velocity (geometry_msgs::Pose target);
...
private:
     ...
     */
    void flock (geometry_msgs::Vector3 vel);
    ...
    /**
     * @brief The type of formation the CPSs should take on.
     */
    string form;
