...
[![Build Status](http://build.ros.org/buildStatus/icon?job=Kdev__swarm_behaviors__ubuntu_xenial_amd64)](http://build.ros.org/job/Kdev__swarm_behaviors__ubuntu_xenial_amd64/)
